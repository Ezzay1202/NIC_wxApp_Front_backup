...
Page({
  ...
  data: {
    listm:[
      {
        text:"管理学创新实验班班会 管理学创新实验班班会", date1:"10-9-11-0" ,date2:"12-00", location:"东久D888",people:"1文1摄" ,fileArray:[{name: "NIC考核标准 (1)(1).docx",
  ...
  uploadFile:function(e) {
    ...
    let fileArray='listm['+index+'].fileArray'
    wx.chooseMessageFile({
        ...
        success: (res) => {
          console.log(res.tempFiles)
            this.setData({
              [fileArray]: this.data.listm[index].fileArray.concat(res.tempFiles)
            })
        }
    })
},
removefile(e){
  this.setData({
    fileArray:this.data.fileArray.pop(e.currentTarget.dataset.item)
  })
},
// 预览附件
previewFile(e) {
